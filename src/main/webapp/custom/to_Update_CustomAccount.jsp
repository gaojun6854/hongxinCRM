							...
							<div class="ui-select span5">
								<select name="customAccount.remark1" onchange="findCity(this.value);">
									...
									<c:forEach items="${areas}" var="area">
										<option value="${area.areaCode}" <c:if test="${customAccount.remark1==area.areaCode}"> selected="selected" </c:if> >${area.areaName}</option>
									</c:forEach>
								</select>
							</div>
						</div>
<script type="text/javascript">
	...
	var cityC=${customAccount.remark2};
						...
						<div class="span12 field-box">
							...
							<div class="ui-select span5">
								<select name="customAccount.remark2" id="cityCode">
									...
									<option value="${city.areaCode}" <c:if test="${customAccount.remark2==city.areaCode}"> selected="selected" </c:if> >${city.areaName}</option>
								   </c:forEach>
								</select>
							</div>
						</div>

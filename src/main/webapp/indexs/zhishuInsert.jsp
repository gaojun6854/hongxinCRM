...
<form action="indexsInfo!zhishuInsert.action" method="post">
系统当前日期:<span id="date_span"></span><br/>
选择日期<input type="text" readonly="readonly" name="indexs.workDate" id="datetimepicker9"><br/>
指  数 值  <input type="text" name="indexs.indexs"><br/>

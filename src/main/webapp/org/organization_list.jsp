...
var nodes = [{ "id":'${organization.orgId}', "name":"红歆财富",isParent:true,iconOpen:"../zTree/css/zTreeStyle/img/diy/1_open.png",iconClose:"../zTree/css/zTreeStyle/img/diy/1_close.png"}];

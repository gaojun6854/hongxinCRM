			...
			<div class="field-box">
				<label>合同起息日</label> <input class="span5 inline-input" name='pactInfo.count_eff' type="text" value="${pactInfo.countEff}" />
							...
							<div class="span11 field-box actions">
								...
								<a class="btn-glow primary" href="pactInfo!offLineReviewsYN.action?id=${pactInfo.pactId}&param=yes">信息凭证审核通过</a>
								<a  href="javascript:void(0);"  class="btn-glow primary" data-reveal-id="myModal" >信息凭证审核不通过</a>

...
<table border="0" cellspacing="0" cellpadding="0" class="dataTable">
  ...
  <tbody>
   <c:forEach items="${autoRepays}" var="autoRepay">
    <tr class="odd_row">
      <td><input type="hidden"  readonly="readonly" id="checkme1" /><a href="pactInfo!getPactInfos.action?no=2&id=${autoRepay.pactId}&redirect=repayment">${autoRepay.pactInfo.contractNumber}</a></td>

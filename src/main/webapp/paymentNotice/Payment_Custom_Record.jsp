...
<form  action="findPaymentToCustomRecord.action" method="post" id="submitForm">
...
<table border="0" cellspacing="0" cellpadding="0" class="dataTable">
  ...
  <tbody>
   <c:forEach items="${pageBean4backAcct.list}" var="backAccount">
    <tr class="odd_row">
      <td><input type="hidden"  readonly="readonly" id="checkme1" />${backAccount.pactInfo.contractNumber}</td>

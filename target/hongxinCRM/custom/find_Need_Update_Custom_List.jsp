...
<table border="0" cellspacing="0" cellpadding="0" class="dataTable">
  ...
  <tbody>
   <c:forEach items="${pageBean.list}" var="custom">
    <tr class="odd_row">
      <td><input type="hidden"  readonly="readonly" id="checkme1" /><a href="addCustomInfo!getCustomInfo.action?id=${custom.id}&redirect=findNeedUpdateSuccessCustom">${custom.custname}</a></td>

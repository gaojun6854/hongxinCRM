...
<form action="indexsInfo!zhishuquery.action" method="post">
...
<table border="0" cellspacing="0" cellpadding="0" class="dataTable">
  ...
  <tbody>
   <c:forEach items="${indexList}" var="index">
    <tr class="odd_row">
	 	  <td><input type="hidden" readonly="readonly" id="checkme1" /><a href="indexsInfo!getIndexsInfo.action?WorkDate=${index.workDate}">${index.workDate}</a></td>
	  <td><input type="hidden" readonly="readonly" id="checkme1" />${index.indexs}</td>
    </tr>
   </c:forEach>
  </tbody>
</table>

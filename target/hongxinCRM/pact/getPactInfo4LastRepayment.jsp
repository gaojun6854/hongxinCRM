		...
		<span style="color: red; font-size: 15px;">${requestScope.flag}<br />
			...
			<div class="field-box">
				<label>合同起息日</label> <input class="span5 inline-input" name='pactInfo.count_eff' type="text" value="${pactInfo.countEff}" />
							...
							<a class="btn-glow primary" href="pactInfo!determineRepay.action?id=${pactInfo.pactId}&param=yes">通过</a>
	  						<a class="btn-glow primary" href="pactInfo!determineRepay.action?id=${pactInfo.pactId}&param=no">不通过</a>
							</div>
						</div>
					</div>
				</div>

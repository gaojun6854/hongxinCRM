...
<div class="section">
	...
	<script type="text/javascript">
		...
		function pactReBuy(){
			...
			$.ajax({ 
		       type: "post", 
		       url: "../pact/pactInfo!addPactInfo.action?amount="+amount+"&custId=${cust.id}"+"&pactId=${pactInfo.pactId}"+"&isRebuy=yes", 
		       cache:false, 
		       async:false, 
		       dataType:"text",
        ...
        function setState( val ) {
            ...
            switch ( state ) {
                ...
                case 'finish':
                    ...
                    if ( stats.successNum ) {
                        alert( '上传成功,点击返回' );
                       var url1="../paymentNotice/findPaymentInfomation.action?no=2&id=${pactInfo.pactId}&redirect=lastRepayment";
